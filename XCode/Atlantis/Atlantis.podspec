...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Andrew Aquino"
  # s.authors            = { "Andrew Aquino" => "andrew@totemv.com" }
  # s.social_media_url   = ""
  ...
  s.source       = { :git => "https://github.com/DrewKiino/Atlantis", :tag => "0.0.1" }
  ...
  s.source_files  = "Source", "https://github.com/DrewKiino/Atlantis/tree/master/XCode/Atlantis/Atlantis/Source/**/*.{swift,h,m}"
